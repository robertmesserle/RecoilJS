    ...
    return [
      {
        ...
        icon: 'magic',
        content: ["Recoil is a light-weight JavaScript framework that provides tools such as two-way data-binding, routing, models, and templating without restricting what you can and can't do as a developer."]
      }, {
        title: 'Why Recoil?',
        icon: 'asterisk',
        content: [
        ...
        icon: 'question-sign',
        content: ["Recoil works by using a process called \"dirty-checking.\"  Basically, when the user interacts with the page, Recoil takes note that the data may have changed and iterates through your data-bindings to see if any UI updates are necessary in order to keep the UI and the data synchronized.", "Contrary to many initial assumptions, this does not rely on intervals or timeouts, and instead relies on user-interaction and events to trigger these checks.", "While this may sound like a lot of work, it all takes place very efficiently resulting in smooth, seamless UI updates."]
      }
    ];
  });
